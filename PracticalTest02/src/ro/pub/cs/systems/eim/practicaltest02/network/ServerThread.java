...
public class ServerThread extends Thread {
    ...
    public ServerThread(int port) {
        ...
        this.data = new HashMap<String, AlarmInformation>();
    }
    ...
    public synchronized void setData(String port, AlarmInformation alarmInformation) {
        this.data.put(port, alarmInformation);
    }
